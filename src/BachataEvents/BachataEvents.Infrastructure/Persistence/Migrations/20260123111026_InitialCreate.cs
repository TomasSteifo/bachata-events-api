...
namespace BachataEvents.Infrastructure.Persistence.Migrations
{
    /// <inheritdoc />
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FestivalEvents", x => x.Id);
                    table.ForeignKey(
                        name: "FK_FestivalEvents_OrganizerProfiles_OrganizerProfileId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FestivalEvents_Country_StartDate",
                table: "FestivalEvents",
                columns: new[] { "Country", "StartDate" });

            migrationBuilder.CreateIndex(
                name: "IX_FestivalEvents_OrganizerProfileId",
                table: "FestivalEvents",
                column: "OrganizerProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_FestivalEvents_StartDate",
                table: "FestivalEvents",
                column: "StartDate");
